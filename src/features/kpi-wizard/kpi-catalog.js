...
// Un KPI se considera "nuevo" durante NEW_BADGE_DAYS días desde su
// `addedAt` (fecha en que se agregó al catálogo). Los 30 KPIs preexistentes
// no tienen `addedAt`, así que nunca muestran el tag.
export function isNewKpi(addedAt) {
...
const KPI_CATALOG = [
  ...
  // Negocio
  {
    ...
    capa: "negocio", subcapa: null, addedAt: "2026-09-15",
  ...
  // Producto
  {
    ...
    capa: "producto", subcapa: null, addedAt: "2026-09-15",
  ...
  // Experiencia
  {
    ...
    capa: "experiencia", subcapa: null, addedAt: "2026-09-15",
